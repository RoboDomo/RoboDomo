...
export default class Denon extends React.Component {
  ...
  render() {
    try {
      if (!this.state || this.state.MV === undefined) {
        //  } || this.state.CVC === undefined) {
      ...
      return (
        <Row>
          <Col sm={1} style={{ marginTop: 10, textAlign: "center" }}>
            <DenonButton topic={topic} value="MSAUTO">
              Auto
            </DenonButton>
            <DenonButton topic={topic} value="MSMOVIE">
              Movie
            </DenonButton>
            <DenonButton topic={topic} value="MSMUSIC">
              Music
            </DenonButton>
          </Col>
