...
export default class Temperature extends Component {
  ...
  constructor({thing}) {
    super()
    this.thing = thing
    this.temperature_topic = [Config.mqtt.smartthings, this.thing.name, 'temperature'].join('/')
  ...
  componentDidMount() {
    MQTT.subscribe(this.temperature_topic, this.handleMessage)
  }

  componentWillUnmount() {
    MQTT.unsubscribe(this.temperature_topic, this.handleMessage)
  }
}
