...
import SmartThings from './screens/SmartThings'
...
export default {
  ...
  routes: {
    dashboard:   { text: 'Dashboard', screen: Dashboard },
    smartthings: { text: 'SmartThings', screen: SmartThings },
    ...
    notFound:    { text: 'Not Found', screen: NotFound }
  },
  dashboards: {
    boards: [
      {
  ...
  denon: {
    receivers: [{ name: 'Family Room Receiver', device: 'denon-s910w' }]
  },
  lgtv: {
    tvs: [
      {
