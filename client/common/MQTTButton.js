...
export default class MQTTButton extends Component {
  constructor(props) {
    ...
    this.state = {
      buttonStyle: props.buttonStyle !== null ? Object.assign({}, Config.ui.buttonStyle, props.buttonStyle || {}) : {},
      buttonSize:  props.buttonStyle !== null ? props.buttonSize || Config.ui.buttonSize : undefined,
